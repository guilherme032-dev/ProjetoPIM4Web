...
namespace ProjetoPIM4.Models
{
    public class Call
    {
        ...
        // Campos para integração com IA
        public string AiClassification { get; set; } // Classificação sugerida pela IA
        public string AiSuggestedSolution { get; set; } // Solução sugerida pela IA
        public string AiTechnicianRecommendation { get; set; } // Técnico recomendado pela IA
    }
}
